...
std::ostream& operator<<(std::ostream &out, const Pentagon<T> &pnt){
    out << "PENTAGON:" << '\n' 
    << "1-я вершина: ( " << pnt._c1.first << ", " << pnt._c1.second << " )" << '\n' 
    << "2-я вершина: ( " << pnt._c2.first << ", " << pnt._c2.second << " )" << '\n'
    << "3-я вершина: ( " << pnt._c3.first << ", " << pnt._c3.second << " )" << '\n'
    << "4-я вершина: ( " << pnt._c4.first << ", " << pnt._c4.second << " )" << '\n'
    << "5-я вершина: ( " << pnt._c5.first << ", " << pnt._c5.second << " )" << '\n';
