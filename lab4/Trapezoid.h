...
std::ostream& operator<<(std::ostream &out, const Trapezoid<T> &tr){
    out << "TRAPEZOID:" << '\n' 
    << "1-я вершина: ( " << tr._c1.first << ", " << tr._c1.second << " )" << '\n' 
    << "2-я вершина: ( " << tr._c2.first << ", " << tr._c2.second << " )" << '\n'
    << "3-я вершина: ( " << tr._c3.first << ", " << tr._c3.second << " )" << '\n'
    << "4-я вершина: ( " << tr._c4.first << ", " << tr._c4.second << " )" << '\n';
