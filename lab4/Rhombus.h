...
std::ostream& operator<<(std::ostream &out, const Rhombus<T> &rmb){
    out << "RHOMBUS:" << '\n' 
    << "1-я вершина: ( " << rmb._c1.first << ", " << rmb._c1.second << " )" << '\n' 
    << "2-я вершина: ( " << rmb._c2.first << ", " << rmb._c2.second << " )" << '\n'
    << "3-я вершина: ( " << rmb._c3.first << ", " << rmb._c3.second << " )" << '\n'
    << "4-я вершина: ( " << rmb._c4.first << ", " << rmb._c4.second << " )" << '\n';
